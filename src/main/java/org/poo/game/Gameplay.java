        ...
        for (GameInput round : rounds) {
            ...
            for (ActionsInput action : round.getActions()) {
                ...
                if (action.getCommand().equals("endPlayerTurn")) {
                    ...
                    processActions.getTotalGamesPlayed(gamesPlayed);
                }
                //process action
                processActions.action(player, currPlayer, action);
            }
